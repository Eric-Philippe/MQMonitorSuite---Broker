...
@Component({
  ...
  templateUrl: './settings-routing-prop.component.html',
  providers: [BrokerAppService],
})
export class RoutingPropsComponent implements OnInit {
  ...
  async ngOnInit() {
    this.brokerRoutingProperties = await this.brokerAppService.getBrokerRoutingProperties();
  }
